    ...
    button.addEventListener("click", () => {
      ...
      if (charArray.includes(button.innerText)) {
        charArray.forEach((char, index) => {
          ...
          if (char === button.innerText) {
            ...
            if (winCount == charArray.length) {
              resultText.innerHTML = alert(
                "You WIN!!! \n The word was " + `${chosenWord}`
              ); //"<h2 class = 'win-msg'>You Win!!!</h2><p>The word was <span>${chosenWord}</span></p>";
        ...
        if (count == 6) {
          ...
          ); //"<h2 class = 'lose-msg'>You Lose! :( </h2><p>The word was <span>${chosenWord}</span></p>";
          blocker();
        }
      }
